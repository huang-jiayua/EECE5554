...
import numpy
from imu.msg import *
from imu.msg import imu_msg
from imu.srv import convert_to_quaternion, convert_to_quaternionResponse
...
def driver():
    ...
    while not rospy.is_shutdown():
        ...
        if "VNYMR" in rawData:
            ...
            msg.orientation_x, msg.orientation_y, msg.orientation_z, msg.orientation_w = euler_to_quaternion(
                roll, pitch, yaw)
